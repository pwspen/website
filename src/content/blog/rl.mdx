...
Reasoning models are the culmination of these advancements. Unlike any previous LLMs (RLHF is not true RL), they have a step in training where the goal is entirely divorced from copying human text. Instead, it's to *be better at thinking*.
